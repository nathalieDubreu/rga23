...
- Nombre de producteurs ayant vendu plus de 2,7 tonnes en 2020, 2021 ou 2022 encore en activité : <font color="blue">`r rga23_coprahculteurs |> filter(indicRGA23_Coprah == 1) |> count()`</font>

- Temps de travail annuel en lien avec l’exploitation des cocoteraies (temps complet, mi-temps, …)

- Nombre de producteurs de coprah (moins de 2,7 tonnes) parmi les exploitants agricoles : <font color="blue">`r rga23_coprahculteurs |> filter(indicRGA23_Coprah == 0) |> count()`</font> coprahculteurs
