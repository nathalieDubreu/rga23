...
# [RGA23] Quelques stats - Données du `r date`
...
- `r rga23_champ |> summarize(sum(NbMOPermFamiliale, na.rm = TRUE))` personnes employées en tant que main d'oeuvre permanente familiale (plus de 8 mois dans l'année, quelque soit le temps de travail)
...
- `r (rga23_champ |> summarize(sum(nbFemmesNFPerm, na.rm = TRUE))) + (rga23_champ |> summarize(sum(nbHommesNFPerm, na.rm = TRUE)))` personnes employées en tant que main d'oeuvre permanente NON familiale (plus de 8 mois dans l'année, quelque soit le temps de travail)
