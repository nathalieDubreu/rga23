...
- <font color = "Red">`r exportRGA |> filter(interview__status == 65) |> count()`</font> entretiens rejetés (erreurs apparentes dans les questionnaires remplis)

**=> `r exportRGA |> filter(interview__status == 120 | interview__status == 100) |> count()` entretiens sont donc terminés et/ou validés**
...
- <font color = "Green">`r exportRGA_interroges |> filter(eligibOrNot == "in") |> count()`</font> unités éligibles
