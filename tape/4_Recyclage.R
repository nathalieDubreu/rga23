# 4. RECYCLAGE 
# 
# RECYCLAGE DE LA BIOMASSE ET DES NUTRIENTS
...
# 
# PRÉSERVATION ET CONSERVATION DE L’EAU
...
# 
# GESTION DES GRAINES ET DES RACES ANIMALES
...
# 
# ENERGIE RENOUVELABLE (UTILISATION ET PRODUCTION)
