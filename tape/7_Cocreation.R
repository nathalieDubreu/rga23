...
score_2_AccesConnaissances <- left_join(rga23_tape,
  ...
  mutate(score = case_when(
    # Bio_DAG
    AgriBio_DAG == 1 ~ 4,
    # Que chimique + ne connait pas les pratiques (ConnaissPratiques)
    (TypeEngrais__1 == 1 & TypeEngrais__2 == 0 & TypeEngrais__3 == 0 & is.na(ConnaissPratiques)) | ConnaissPratiques == 2 ~ 0,
    # Que chimique sauf éventuellement sur un engrais + connait les pratiques
    (TypeEngrais__1 == 1 & (TypeEngrais__2 == 1 | TypeEngrais__3 == 1) & is.na(ConnaissPratiques)) | ConnaissPratiques == 1 ~ 1,
    # Mixte chimique et bio + participation souvent ou toujours aux plateformes
    ...
    # Pas de chimique (produits bio ou rien)
